...
namespace Aheadworks\Sarp2\Model\Payment\Sampler\Gateway\Braintree\Response\PayPal;
 ...
 *
 * @package Aheadworks\Sarp2\Model\Payment\Sampler\Gateway\Braintree\Response\PayPal
 */
class VaultDetailsHandler implements HandlerInterface
{
    ...
    public function handle(array $handlingSubject, array $response)
    {
        ...
        $this->tokenAssigner->assignByPayPalDetails($payment, $transaction->paypalDetails);
