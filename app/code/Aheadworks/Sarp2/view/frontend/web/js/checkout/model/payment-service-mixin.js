    ...
    return function (paymentService) {
        return _.extend(paymentService, {
            ...
            setPaymentMethods: function (methods) {
                ...
                if (grandTotal <= 0) {
                    filteredMethods = quote.isAwSarp2QuoteSubscription() || quote.isAwSarp2QuoteMixed()
                        ? _.filter(methods, isMixedPaymentMethod)
                        : _.filter(methods, isFreePaymentMethod);
            ...
            getAvailablePaymentMethods: function () {
                ...
                if (grandTotal > 0) {
                    ...
                    return quote.isAwSarp2QuoteSubscription() || quote.isAwSarp2QuoteMixed()
                        ? _.filter(allMethods, isMixedPaymentMethod)
                        : _.filter(allMethods, isFreePaymentMethod);
                }
            }
        });
    }
