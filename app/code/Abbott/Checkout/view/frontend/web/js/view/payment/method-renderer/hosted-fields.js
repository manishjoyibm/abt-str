    ...
    return Component.extend({
        ...
        placeOrderClick: function () {
            if (this.validateFormFields() && additionalValidators.validate()) {
                // Show Error Msg in-case user unchecks "Save for Later use" while ordering subscriptions
                let restrictOrder = window.checkoutConfig.isAwSarp2QuoteMixed || window.checkoutConfig.isAwSarp2QuoteSubscription;
