...
class Otp extends AbstractModel implements IdentityInterface, OtpInterface
{
    ...
    public const CACHE_TAG = 'abbott_twoaf_auth';

    /**
     * @var string
     */
    protected $cacheTag = 'abbott_twoaf_auth';

    /**
     * @var string
     */
    protected $eventPrefix = 'abbott_twoaf_auth';
    ...
    {
        $this->_init(\Abbott\CustomerTwoFactorAuth\Model\ResourceModel\Otp::class);
    }
