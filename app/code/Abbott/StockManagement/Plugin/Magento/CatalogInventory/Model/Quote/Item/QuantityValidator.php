...
namespace Abbott\StockManagement\Plugin\Magento\CatalogInventory\Model\Quote\Item;
...
class QuantityValidator
{
    ...
    public function aroundValidate(
        ...
        if (($options = $quoteItem->getQtyOptions()) && $qty > 0) {
            ...
            if (isset($quoteItem->getData()['aw_sarp_regular_price']) &&
                $quoteItem->getData()['aw_sarp_regular_price'] == 0
            ) {
        ...
        $this->checkItemForOptions($options, $product, $quoteItem, $stockStatus);
    }

    private function checkItemForOptions($options, $product, $quoteItem, $stockStatus)
    {
        /**
        ...
        if ($options) {
            ...
            if ($quoteItem->getParentItem() === null && $quoteItem->getStockStateResult() !== null) {
