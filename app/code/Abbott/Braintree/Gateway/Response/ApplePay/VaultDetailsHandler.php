...
namespace Abbott\Braintree\Gateway\Response\ApplePay;
...
class VaultDetailsHandler implements HandlerInterface
{
    ...
    protected function getVaultPaymentToken(Transaction $transaction)
    {
        ...
        $applePayExpirationMonth = $transaction->applePayCardDetails->expirationMonth;
        $applePayExpirationYear = $transaction->applePayCardDetails->expirationYear;


        $paymentToken->setTokenDetails($this->convertDetailsToJSON([
            'maskedCC' => $transaction->applePayCardDetails->last4,
            'expirationDate' => $applePayExpirationMonth."/".$applePayExpirationYear
        ]));
