...
namespace Abbott\Braintree\Gateway\Response\PayPal;
...
use PayPal\Braintree\Gateway\Response\PayPal\VaultDetailsHandler as VaultDetailsHandlerCore;

class VaultDetailsHandler extends VaultDetailsHandlerCore
{
    /**
    ...
    private function getVaultPaymentToken(Transaction $transaction): ?PaymentTokenInterface
    {
        ...
        // This fixes duplicate stored Paypal issue
        $details = json_encode([
