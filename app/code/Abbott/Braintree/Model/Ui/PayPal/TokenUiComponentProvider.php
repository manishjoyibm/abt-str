...
namespace Abbott\Braintree\Model\Ui\PayPal;
...
use PayPal\Braintree\Model\Ui\PayPal\TokenUiComponentProvider as TokenUiComponentProviderCore;
 ...
 */
class TokenUiComponentProvider extends TokenUiComponentProviderCore
{
    /**
    ...
    public function getComponentForToken(PaymentTokenInterface $paymentToken): TokenUiComponentInterface
    {
        ...
        //Code added to fix ANAPOLLO-7557 caused by ANAPOLLO-6670
        return $this->getVaultComponent($config);
        //Code added to fix ANAPOLLO-7557
    }
