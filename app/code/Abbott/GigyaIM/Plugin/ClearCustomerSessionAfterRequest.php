...
use Abbott\GigyaIM\Model\Context\AddUserInfoToContext;
...
class ClearCustomerSessionAfterRequest
{
    ...
    public function __construct(
        ...
        $this->addUserInfoToContext = $addUserInfoToContext ?? ObjectManager ::
        getInstance()->get(AddUserInfoToContext::class);
    }
