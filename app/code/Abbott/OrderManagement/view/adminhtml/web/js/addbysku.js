...
define([
    ...
    AddBySku.prototype = {
        ...
        initialize: function (order, data) {
            let originConfiguredCheck, originRequestConfiguration;
            ...
            adminCheckout.prototype.submitConfigured = function () {
                ...
                let oldSourceGrids = this.order.sourceGrids,
            ...
            adminCheckout.prototype.updateErrorGrid = function (params) {
                let oldLoadingAreas = this.order.loadingAreas,
                    url;
             ...
             */
           function adminOrder() {
               /* let skuAreaId = this.order.getAreaId('additional_area');
            ...
            adminOrder.prototype.submitConfigured = function () {
                let area = ['errors', 'search', 'items', 'shipping_method', 'totals', 'giftmessage','billing_method'],
        ...
        submitSkuForm: function () {
            let $form, $file, requestParams, sku, i;
        ...
        configure: function (id, sku) {
            let productRow = $('sku_errors_table').select('div[id=sku_' + sku + ']')[0],
            ...
            productConfigure.setShowWindowCallback(this.listType, function () {
                ...
                let qty = productQtyElement.value,
                    formCurrentQty;
        ...
        clearAddForm: function () {
            let $rows = $(this.dataContainerId).select('tr'),
                rowNum = $rows.length,
                i;
