...
/**
 * Abstract collection of InboundFeed
 */
abstract class AbstractCollection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    protected function performAfterLoad($tableName, $linkField): void
    {
        ...
        if (count($linkedIds)) {
            ...
            if ($result) {
                $this->updateItemData($result, $linkField);
            }
        }
    }
     ...
     * @throws NoSuchEntityException
     */
    private function updateItemData(array $result, ?string $linkField): void
    {
        $storesData = [];
        foreach ($result as $storeData) {
            $storesData[$storeData[$linkField]][] = $storeData[self::STORE_ID];
        }
        ...
        foreach ($this as $item) {
            ...
            $item->setData(self::STORE_ID, $storesData[$linkedId]);
        }
    }
}
