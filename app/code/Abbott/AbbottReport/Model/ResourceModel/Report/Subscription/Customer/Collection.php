<?php
namespace Abbott\AbbottReport\Model\ResourceModel\Report\Subscription\Customer;
...
class Collection extends \Magento\Sales\Model\ResourceModel\Report\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        $resource->init('aggregated_customer_subscription');
    ...
    protected function _beforeLoad()
    {
        ...
        if (!$this->isTotals() && !$this->isSubTotals()) {
            $this->getSelect()->group([$this->periodFormat, 'customer_name']);
        }
        if ($this->isSubTotals()) {
