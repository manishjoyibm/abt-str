define([
    ...
    $.widget('mage.productVideoLoader', {
        ...
        _create: function () {
            switch (this.element.data('type')) {
                ...
                // BEGIN CUSTOM CODE :- Added for ANAPOLLO-6657
                case 'custom':
                    break;
                // CUSTOM CODE ENDS - Added for ANAPOLLO-6657
                default:
                    throw {
    ...
    $.widget('mage.videoData', {
        ...
        _onRequestHandler: function () {
            ...
            if (type === 'youtube') {
            ...
            } else if (type === 'custom') {      // Start Custom code - Added for ANAPOLLO-6657
                var videoData = {
                    title: 'Tittle',
                ...
                this._videoInformation = videoData;
                this.element.trigger(this._UPDATE_VIDEO_INFORMATION_TRIGGER, videoData);
                this.element.trigger(this._FINISH_UPDATE_INFORMATION_TRIGGER, true);
            }  // End Custom code - Added for ANAPOLLO-6657
        },
        ...
        _validateURL: function (href, forceVideo) {
            ...
            } else {  // CUSTOM CODE STARTS - Added for ANAPOLLO-6657
