...
namespace Abbott\MyAccount\Model\System;
...
class Store extends \Magento\Framework\DataObject implements OptionSourceInterface
{
     ...
     */
    public function __construct(\Magento\Store\Model\StoreManagerInterface $storeManager, \Abbott\MyAccount\Helper\LinkData $helperData, \Magento\Framework\App\RequestInterface $request)
    {
    ...
    {
		$isEdit = $this->request->getParam('id');
        ...
        foreach ($this->_websiteCollection as $website) {
            ...
            foreach ($this->_groupCollection as $group) {
                ...
                foreach ($this->_storeCollection as $store) {
                    ...
                    $isEmailEditDisabled = $this->_helperData->getEmailEditDisableFlag($store->getId());
                    
                    if($isEmailEditDisabled!=1 && $isEdit == ""){
                        if (!$websiteShow) { 
