...
namespace Abbott\MyAccount\Test\Unit\Plugin\Controller\GiftCardAccount\Customer;
...
class IndexPluginTest extends \PHPUnit\Framework\TestCase
{
     ...
     public function setUp() : void
    {
        ...
        $this->indexPluginMock = $objectManager->getObject(
            \Abbott\MyAccount\Plugin\Controller\GiftCardAccount\Customer\IndexPlugin::class,
            [
    ...
    {
        $layoutName = "customer-account-navigation-gift-card-link";
        ...
        $this->setRedirect(true);
        $this->assertEquals($test['expected_result'], $this->isRedirect(), "DoGift Card Page URL redirect - enabled");
