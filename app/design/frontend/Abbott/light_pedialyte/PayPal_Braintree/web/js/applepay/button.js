                    ...
                    self.collectDeviceData(clientInstance, context, function () {
                        applePay.create({
                            ...
                            el.addEventListener('click', function (e) {
                                ...
                                let agreementId = jQuery('#payment-method-braintree-applepay .payment-method-content .checkout-agreements-block .checkout-agreements .checkout-agreement input[type="checkbox"]').val();

                                if (!jQuery('#agreement_braintree_applepay_'+agreementId).is(":checked")) {
                                    if (jQuery(".validate-applepay").length == 0) {
                                        var html = '<div for="agreement[' + agreementId + ']" generated="true" class="mage-error validate-applepay" id="agreement[' + agreementId + ']-error">This is a required field.</div>';
                                        jQuery("label[for='agreement_braintree_applepay_" + agreementId + "']").append(html);
                                    }
                                    return false;
                                } else {
                                    jQuery(".validate-applepay").remove();
                                }
