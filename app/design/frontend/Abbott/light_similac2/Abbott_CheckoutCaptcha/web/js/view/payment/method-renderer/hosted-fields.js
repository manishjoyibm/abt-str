...
define([
    ...
    return Component.extend({
        ...
        initialize: function () {
            ...
            var configCount = parseInt(window.checkoutConfig["payment_failed_count"]);
            return this;
        },
        ...
        placeOrderClick: function () {
            ...
            var validateCaptcha = document.forms["co-transparent-form-braintree"]["g-recaptcha-response"] ? true : false;
            if (this.validateFormFields() && additionalValidators.validate()) {
                var restrictOrder = window.checkoutConfig.isAwSarp2QuoteMixed || window.checkoutConfig.isAwSarp2QuoteSubscription;
                if(this.isVaultEnabled() && restrictOrder && !this.vaultEnabler.isActivePaymentTokenEnabler()) {
                    $("#save-card-alert").show();
                    return;
                }
                $("#save-card-alert").hide();
