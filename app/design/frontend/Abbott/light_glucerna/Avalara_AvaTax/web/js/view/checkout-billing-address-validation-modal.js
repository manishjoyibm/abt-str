                ...
                },
                {
                    ...
                    click: function () {
                        ...
                        if(checkoutData.getSelectedPaymentMethod() == 'braintree_paypal'){
                            var paypal_agreement_id = $("input[name='amastyPaymentMethodAttributes[glucerna_terms]']").attr('id');
                            var paypal_agreement = document.querySelector('#'+paypal_agreement_id);
                            paypal_agreement.dispatchEvent(new Event("change"));
                        }else{
